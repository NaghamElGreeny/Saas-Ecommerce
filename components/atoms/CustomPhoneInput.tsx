          ...
          <>
            <div className="flex items-center">
              ...
              <input
                ...
                className="focus:border-primary mx-2 w-full rounded-lg border border-gray-300 p-2 py-3 focus:ring-2 focus:ring-transparent focus:outline-none dark:border-[#17263c] dark:bg-[#121e32]"
                value={phone || ""}
              ...
              <div className="relative">
                <Dropdown
                  button={
                    <div className="border-primary text-text-website-font flex items-center rounded-lg border p-2 px-5 py-3 dark:border-[#17263c] dark:bg-[#121e32]">
                      {/* Display selected country's flag and code */}
                      <img
                        onError={(e: any) => (e.target.src = imageError)}
                        src={
                          countries.find((c) => c.dialCode == values.phone_code)
                            ?.flag || imageError
                        }
                        alt="flag"
                        className="h-4 w-6"
                ...
                >
                  <div className="border-primary absolute top-full right-0 z-50 mt-2 max-h-48 w-20 overflow-y-auto rounded-lg border bg-white shadow-md dark:border-[#17263c] dark:bg-[#121e32]">
                    {countries.map((country) => (
                      <div
                        key={country.dialCode}
                        className="dropdown-item hover:bg-secondary flex cursor-pointer items-center p-2 hover:text-white"
