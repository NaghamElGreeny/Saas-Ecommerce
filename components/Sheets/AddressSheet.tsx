  ...
  return (
    <>
      ...
      <div className="flex-grow overflow-hidden p-4">
        <ScrollArea className="flex h-full w-full overflow-y-auto">
      ...
      <SheetFooter className="flex h-fit flex-col items-center justify-center">
        ...
        >
          <DialogTrigger asChild>
            <button className="mt-4 flex h-10 w-[80%] items-center justify-center gap-2 rounded-full bg-primary border border-primary text-white cursor-pointer hover:bg-white hover:text-primary">
              Add new address
            </button>
          </DialogTrigger>
